...
def create_mp3(text):
    ...
    print "Trying to create voice for the text: '{}'".format(text)
...
def listen_print_loop(responses):
    ...
    for response in responses:
		...
		print u"Will try to print '{}' in English!!".format(text)
			
    		translation = translate_client.translate(
        		text,
        		target_language=target)

		ustr = u'{}'.format(translation['translatedText'])
		print(ustr)
		print translation
		#ustr = ustr.encode('utf8')
    		
		'''
		#print(u'Romanized: {}'.format(unidecode(translation['translatedText'])))
		
		romanized = unidecode(translation['translatedText'])
		'''
		mixer.init()
		#mixer.music.play(create_mp3(ustr))
		create_mp3(ustr)
...
def main():
    ...
    if param_lang in supported_lang:
        ...
        print "Language {} not supported! Please use one of the below language:\n{}".format(param_lang, supported_lang)
        sys.exit(0)
